...
public class BookedAppointments implements Serializable {
    ...
    public BookedAppointments(Integer id, String status, String doctorComment, Appointments appointmentId, Users userId) {
        this.id = id;
        this.status = status;
    ...
    public BookedAppointments() {
     ...
     public BookedAppointments(Integer appId, Integer userId, String status) {
        this.appointmentId = new Appointments(appId);  // Assuming there's a constructor in the Appointments class that accepts an ID.
        this.userId = new Users(userId);  // Assuming there's a constructor in the Users class that accepts an ID.
        this.status = status;
    }
