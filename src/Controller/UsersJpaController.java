...
public class UsersJpaController implements Serializable {
    ...
    EntityManager em = getEntityManager();
    try {
        Query query = em.createQuery("SELECT u FROM Users u WHERE u.firstname = :firstName");
    ...
    public int getUsersCount() {
     ...
     public List<Users> findUsersByUsernameAndPassword(String username, String password) {
      ...
      public List<Users> findPatients() {
        EntityManager em = getEntityManager();
        try {
            Query query = em.createQuery("SELECT u FROM Users u WHERE u.role = :role");
